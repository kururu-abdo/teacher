      ...
      child: Scaffold(
          ...
          body: TabBarView(children: [
            StreamBuilder<QuerySnapshot>(
              stream: users.where('subject_id' , isEqualTo: widget.subject.id).snapshots(),
...
//         
            ...
            StreamBuilder<QuerySnapshot>(
              stream: events.where('subject_id', isEqualTo: widget.subject.id).snapshots(),
    ...
    return 
             ...
             GestureDetector(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (_) => Material(
                                child: EventDeitals(snapshot.data.docs[index].data()))));
                      },
                      child: Container(
